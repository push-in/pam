...
verify_split() (
    ...
    expected_files='^(LICENSE|README\.md|CHANGELOG\.md|UPGRADE\.md|CONTRIBUTING\.md|CODE_OF_CONDUCT\.md|SECURITY\.md|PROTOCOL\.md|composer\.json|composer\.lock|config/|docs/|src/|tests/|benchmarks/|resources/|bin/|phpstan\.neon|index\.php|phpunit\.xml|\.env\.example|\.gitignore)'
