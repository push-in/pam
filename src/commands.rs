...
fn init_api(directory: &Path, socket: bool) -> Result<(), String> {
    ...
    let mut manifest = serde_json::json!({
        ...
        "require-dev": {
            "laravel/pint": "^1.30",
            "pushinbr/pam-http-testing": testing_version,
...
fn init_mobile(
    ...
    requirements[native_package] = serde_json::json!("^0.9");
    if with_official_ui {
        requirements["pushinbr/pam-native-ui"] = serde_json::json!("^0.9");
    }
    let mut manifest = serde_json::json!({
            ...
            serde_json::json!({
                ...
                "options": {
                    ...
                    "versions": {
                        ...
                        "pushinbr/pam-http-psr": "1.0.0",
                        "pushinbr/pam-socket": "1.1.0",
                        "pushinbr/pam-http-testing": "1.0.0"
                    }
                }
            })
        })
