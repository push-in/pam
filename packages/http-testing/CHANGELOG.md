...
- Publish the HTTP test client under the permanent `pushinbr/pam-http-testing` name.
- Introduce the `Pam\Http\Testing` namespace and retain aliases for `Pam\Testing` migration.
