...
| Cross-surface release authority and recovery | iOS audit artifact workflow `8e5e1fc` | Native release audit `58fe1d8`; source, device-host and aggregate plugin tag gates `9da8325` | Permission policy `46fead6`; interrupted updater recovery `e82efd6`; full source-contract gate for native and API-only tags `bd8ec18` | Fail-closed tag publication shipped across Native/Desktop; platform sandbox certification remains open |
