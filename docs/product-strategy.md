...
| Cross-surface observability | Prometheus/control-plane metrics, structured access logs and W3C server-child trace lineage `338c780` | Bounded native performance timeline in schema 1 diagnostics | Command metrics and bounded live diagnostics | Core metrics and trace lineage shipped; unified performance timeline and stable OTLP export remain open |
